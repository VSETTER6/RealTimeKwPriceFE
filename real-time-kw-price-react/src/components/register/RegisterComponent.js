...
import axiosInstance from "../../services/api/realTimeKwPriceAPI";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post('/createUser', {
        ...
        phoneNumber: formData.phoneNumber // Send phoneNumber in request
      });
              ...
              <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <a href="#" className="text-gray-700 underline dark:text-gray-200">terms and conditions</a> and
